-- Recreate handle_order_delivered_commission (unchanged logic) + run backfill
...
-- One-time backfill: credit commissions for already-paid referred orders never credited
DO $$
DECLARE
  o RECORD;
  v_referral jsonb;
