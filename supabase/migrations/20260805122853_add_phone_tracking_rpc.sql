-- Create an RPC to safely lookup recent orders by phone number
...
BEGIN
  ...
  -- Must be at least 9 characters long to be a valid phone number
  ...
  SELECT o.public_order_id, o.status, o.network, o.bundle_snapshot, o.created_at
   ...
   WHERE o.beneficiary_number = v_phone
      OR o.beneficiary_number LIKE '%' || v_phone -- e.g. handle 024 vs 23324
