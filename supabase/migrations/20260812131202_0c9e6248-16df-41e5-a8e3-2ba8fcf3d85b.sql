...
REVOKE EXECUTE ON FUNCTION public.get_top_selling_packages(text) FROM anon;
GRANT EXECUTE ON FUNCTION public.get_top_selling_packages(text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_top_selling_packages(text) TO service_role;
...
REVOKE EXECUTE ON FUNCTION public.get_order_status_breakdown(text) FROM anon;
GRANT EXECUTE ON FUNCTION public.get_order_status_breakdown(text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_order_status_breakdown(text) TO service_role;
...
REVOKE EXECUTE ON FUNCTION public.get_payment_method_breakdown(text) FROM anon;
GRANT EXECUTE ON FUNCTION public.get_payment_method_breakdown(text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_payment_method_breakdown(text) TO service_role;