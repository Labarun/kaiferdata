-- Migration: Add buying_enabled column to public.data_packages and update related RPC functions
ALTER TABLE public.data_packages ADD COLUMN IF NOT EXISTS buying_enabled boolean DEFAULT true;

-- 1. Update public.list_public_packages function
...
-- 2. Update public.purchase_with_wallet_atomic function
...
BEGIN
  ...
  SELECT id, network, package_name, package_code, package_size_label,
         selling_price, agent_base_price, currency, is_active, validity_label, buying_enabled
...
-- 3. Update public.purchase_bulk_with_wallet_atomic function
