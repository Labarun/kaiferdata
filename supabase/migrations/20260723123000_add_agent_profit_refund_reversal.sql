-- Add refund reversal logic for storefront agent profit.
-- When a storefront order is marked refunded, reverse the previously credited
-- agent profit row and deduct the same amount from the agent earnings wallet.
