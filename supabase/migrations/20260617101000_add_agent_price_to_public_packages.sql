-- Update list_public_packages to return agent_base_price conditionally
...
-- Update handle_order_delivered_commission to resolve agent_base_price from db securely
