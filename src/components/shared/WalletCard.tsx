...
export function WalletCard({ compact }: { compact?: boolean }) {
  ...
  return (
    <motion.div 
      ...
      className="glass-wallet-hero rounded-2xl shimmer-edge refraction-rim overflow-hidden p-6 relative"
    >
      {/* Ambient glow orbs */}
      ...
      <div className="flex items-center gap-3 mb-5 relative z-[1]">
        <div className="p-2.5 rounded-xl bg-primary/10 border border-primary/10 shadow-[0_0_12px_-4px_hsl(var(--primary)/0.15)]">
