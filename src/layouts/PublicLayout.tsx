  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        {/* Button */}
        <span className="relative flex items-center gap-2 h-12 w-12 sm:w-auto sm:px-4 sm:pr-5 rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/25 hover:shadow-xl hover:shadow-[#25D366]/35 hover:scale-105 active:scale-95 transition-all duration-200 justify-center sm:justify-start">
          ...
          <span className="hidden sm:inline text-[11px] font-semibold tracking-wide">WhatsApp</span>
        </span>
      </a>
